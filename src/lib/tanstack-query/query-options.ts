...
export const eventKeys = {
	...
	paginatedList: (page: number, pageSize: number) =>
		[...eventKeys.lists(), "paginated", page, pageSize] as const,
	...
	eventCount: () => [...eventKeys.all, "count"] as const,
};
...
export const getEventCountQueryOptions = () =>
	queryOptions({
		queryKey: eventKeys.eventCount(),
		queryFn: () => getEventCount(),
	});

export const getPaginatedEventsQueryOptions = ({
	page,
	pageSize,
}: {
	page: number;
	...
	queryOptions({
		queryKey: eventKeys.paginatedList(page, pageSize),
		queryFn: () => getEventsPaginated({ page, pageSize }),
	});
