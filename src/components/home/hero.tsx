  ...
  return (
    ...
    >
      <div className="relative mx-auto h-full max-w-full overflow-hidden">
        {/* Geometric accents */}
        <div
          className="hero-shape absolute h-[176px] w-[176px] rounded-full border-[14px] border-white/95"
          data-direction="left"
        ></div>
        <div
          className="hero-shape absolute left-[30%] top-[10%] h-12 w-12 rounded-full border-[8px] border-white/95"
          data-direction="right"
        ></div>
        <div
          className="hero-shape absolute bottom-4 left-4 h-20 w-20 rounded-full border-[10px] border-white/95"
          data-direction="left"
        ></div>
        <div
          className="hero-shape absolute right-24 bottom-0 h-72 w-72 rounded-full border-[12px] border-white/95"
          data-direction="right"
        ></div>
        <div
          className="hero-shape absolute right-[35%] top-[16%] h-48 w-48 border-[10px] border-white/95 rotate-45"
          data-direction="right"
        ></div>
        <div
        ...
        ></div>
        <div
          className="hero-shape absolute bottom-8 left-[30%] h-20 w-20 rotate-45 border-[8px] border-white/95"
          data-direction="left"
        ></div>
        ...
        <div className="relative mx-auto max-w-full px-4 py-10 md:px-6 md:py-8">
          <div className="grid items-center gap-8 md:grid-cols-2 md:items-start">
            {/* Left side - Content */}
            <div className="z-10 flex flex-col items-center pt-10 text-center sm:pt-14 md:items-start md:pt-[100px] md:pl-[140px] md:text-left">
              {/* CDG Logo + wordmark */}
