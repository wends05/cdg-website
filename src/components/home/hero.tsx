...
const leftColumnActivities = [
  "devcon-group-pic.jpg",
  "hour-of-ai.jpg",
  "ml-group.png",
  "outreach-kids.jpg",
  "outreach.jpg",
...
const leftScrollActivities = [...leftColumnActivities, ...leftColumnActivities];
const rightScrollActivities = [
...
function OfficerImageItem({
  ...
  return (
    <div className="relative aspect-[4/5] w-full overflow-hidden rounded-3xl shadow-[0_12px_30px_rgba(20,33,110,0.24)]">
      {!isLoaded && (
