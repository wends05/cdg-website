...
export function AuthPage() {
	...
	return (
		<div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100 relative overflow-hidden">
			<div className="absolute inset-0 overflow-hidden pointer-events-none">
				...
				<div className="absolute top-20 left-1/4 w-px h-40 bg-linear-to-b from-blue-300 to-transparent opacity-40" />
				<div className="absolute bottom-1/3 right-1/4 w-40 h-px bg-linear-to-r from-yellow-300 to-transparent opacity-40" />
