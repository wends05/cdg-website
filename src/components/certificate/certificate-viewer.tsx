	...
	return (
		<div className="min-h-screen bg-white py-8 px-4">
			<div className="max-w-5xl mx-auto space-y-8">
				<h2 className="text-2xl font-bold text-blue-600 text-center">Certificate of Completion</h2>
				...
				<div className="bg-white border border-gray-200 shadow-lg px-12 py-10">
					...
					<div className="space-y-1 mb-12">
						<p className="text-xl font-bold text-blue-600">{participant.name}</p>
					...
					<p className="text-xs text-gray-600 leading-relaxed max-w-4xl">
						This certificate verifies that {participant.name} successfully completed {event.name}.
						The certificate indicates the entire course was completed as validated by the participant.
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
					...
					<div className="space-y-4 self-stretch flex flex-col h-full">
						<div className="bg-white border border-gray-200 shadow-sm p-4 space-y-2">
							...
							<p className="text-xs text-gray-700 break-all">{participant.email}</p>
						</div>
